              ...
              <div className='project-box-container'>
                <div className='grid-item1'>
                  <Fade triggerOnce duration={1000} direction='left'>
                    <div className="project-box">
                        <a href="/Chatchanan/project/nawintrade"><img src="./../public/project_image/" alt="" />
                      ...
                      <div className='text'>
                        ...
                        <a href='/Chatchanan/project/nawintrade' className='view'>View project</a>
                ...
                <div className='grid-item2'>
                  <Fade triggerOnce duration={1000} direction='right'>
                    <div className="project-box">
                      <a href="/Chatchanan/project/Caraball">
                        <div className='image image-1'>
                      ...
                      <div className='text'>
                        ...
                        <a href="/Chatchanan/project/Caraball" className='view'>View project</a>
                ...
                <div className='grid-item3'>
                  <Fade triggerOnce duration={1000} direction='left'>
                    <div className="project-box">
                      <a href='/Chatchanan/project/califonia' className='view'>
                        <div className='image image-1'>
                      ...
                      <div className='text'>
                        ...
                        <a href='/Chatchanan/project/califonia' className='view'>View project</a>
